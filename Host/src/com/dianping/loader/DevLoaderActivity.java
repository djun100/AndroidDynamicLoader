 ...
 * 
 */
public class DevLoaderActivity extends BaseActivity {
    ...
    private class MyHttpServer extends EmbedHttpServer {
        ...
        protected void handle(String method, String path, HashMap<String, String> headers, InputStream input,
            ...
            if ("GET".equalsIgnoreCase(method) && "/list".equalsIgnoreCase(path)) {
                    ...
                    if (id.isDirectory()) {
                        for (File file : id.listFiles()) {
                            if (file.isFile() && file.getName().endsWith(".apk")) {
                                String str = id.getName() + "/" + file.getName() + "\n";
            ...
            if ("PUT".equalsIgnoreCase(method) && ("/site".equals(path) || "/site.txt".equals(path))) {
            ...
            if ("GET".equalsIgnoreCase(method) && (path.startsWith("/go/") || path.startsWith("/debug/"))) {
                StringBuilder sb = new StringBuilder(MyApplication.PRIMARY_SCHEME);
                sb.append("://").append(path.substring(path.indexOf('/', 1) + 1));
    ...
    private class WaitForDebugger extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == 1) {
                AlertDialog.Builder b = new AlertDialog.Builder(DevLoaderActivity.this);
                b.setTitle("Waiting For Debugger..");
                b.setIcon(android.R.drawable.ic_dialog_alert);
                b.setMessage(Html.fromHtml("Go to eclipse, open DDMS perspective, debug <b>" + getPackageName()
                        + "</b> in Devices panel"));
